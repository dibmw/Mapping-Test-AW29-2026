      ...
      >
        ...
        <div className="bg-gradient-to-r from-brand-green via-brand-green-light to-brand-green-dark p-4 text-white flex justify-between items-center border-b-4 border-brand-gold">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white/15 rounded-full flex items-center justify-center font-display font-bold text-brand-gold text-lg border border-white/20">
              MT
            </div>
            <div>
              ...
              <p className="text-[10px] opacity-80 font-mono">AL-WILDAN ISLAMIC SCHOOL</p>
            </div>
          </div>
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-3.5 p-3 rounded-xl hover:bg-gray-50/50 transition-colors">
              ...
              <div className="space-y-0.5">
                <span className="text-[10px] uppercase font-bold tracking-wider text-gray-400">Hari / Tanggal</span>
                <p className="font-display font-bold text-gray-800 text-sm md:text-base">{siswa.day}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5 p-3 rounded-xl hover:bg-gray-50/50 transition-colors">
              ...
              <div className="space-y-0.5">
                <span className="text-[10px] uppercase font-bold tracking-wider text-gray-400">Lokasi / Ruangan</span>
                <p className="font-display font-bold text-gray-800 text-sm md:text-base">Ruang {siswa.ruang}</p>
              </div>
            </div>
          </div>
            ...
            <div className="divide-y divide-gray-50">
              ...
              <div className="p-4 flex items-center justify-between hover:bg-gray-50/30 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs font-semibold text-gray-800 block">Waktu Keseluruhan</span>
                    <span className="text-[11px] text-gray-400">Durasi total ujian</span>
                  </div>
                </div>
              ...
              <div className="p-4 flex items-center justify-between hover:bg-gray-50/30 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs font-semibold text-gray-800 block">Waktu English / Catung</span>
                    <span className="text-[11px] text-gray-400">Jenjang SD (Catung) / SMP-SMA (Eng)</span>
                  </div>
                </div>
              ...
              <div className="p-4 flex items-center justify-between hover:bg-gray-50/30 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs font-semibold text-gray-800 block">Waktu Al-Qur'an / Arab</span>
                    <span className="text-[11px] text-gray-400">Jenjang SD (Hijaiyah) / SMP-SMA (Arab)</span>
                  </div>
                </div>
          ...
          <div className="p-3.5 bg-amber-50/50 border border-amber-200/50 rounded-xl flex gap-2.5 text-xs text-amber-800">
            <span className="font-bold text-base leading-none text-brand-gold">⚠️</span>
            <p className="leading-normal">
              Siswa wajib hadir di sekolah paling lambat <strong className="font-bold">10 menit sebelum</strong> jadwal di atas dimulai. Tidak perlu membawa alat tulis karena ini merupakan ujian lisan.
            </p>
          </div>
        </div>
      </div>
        ...
        >
          {copied ? (
            <>
              ...
              <span className="text-emerald-600 font-semibold">Salin Berhasil</span>
            </>
          ) : (
            <>
